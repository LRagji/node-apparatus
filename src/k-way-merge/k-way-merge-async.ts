 ...
 */
export async function* kWayMergeAsync<T>(iterators: AsyncIterableIterator<T>[], frameProcessFunction: (elements: (T | null)[]) => { yieldIndex: number | null, purgeIndexes: number[] }): AsyncIterableIterator<T> {
